...
import {FirstPageComponent} from '../app/views/pages/first-page/first-page.component'
// import { ModalComponent } from './views/pages/first-page/modal/modal.component';
const routes: Routes = [
...

	{
		...
		children: [
			{
				path: 'first-page', // <= Page URL
				component: FirstPageComponent // <= Page component registration
			  },
